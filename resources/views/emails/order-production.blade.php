    ...
    <div style="
        ...
        padding-top: 60px;">
            ...
            margin-bottom: 50px;">
                ...
                font-weight: bold;
                font-size: 2rem;
                margin: 9px 0;">Hey {{$user->first_name}} {{$user->last_name}}, your order is in production.</h2>
            </div>
            <div style="width: 100%; float:left;"><img style="float: none;
                display: inline-block;
                box-sizing: border-box;
                margin-bottom: -4px;
                max-width: 100%;" src="{{asset('img/thanku.png')}}" alt=""></div>
        </div>
        <div  style="float: left;
        width: 100%;
        box-sizing: border-box;
        ...
        padding-top: 80px;">
            ...
            margin-left: auto;">
                ...
                margin-top: 0;
                font-size: 1.75rem;
                margin-bottom: 30px;">{{$order->name}} Summary</h3>
                    ...
                    margin-left: -15px;">
                        <div style="
                            ...
                            padding: 33px 0;">
                                ...
                                font-weight: bold;
                                letter-spacing: 0px;
                                margin-bottom: 2px;">Submitted Date</h3>
                                <span style="float: left;
                                width: 100%;
                                box-sizing: border-box;
                                font-size: 14px;
                                color: #000;">{{$order->created_at}}</span>
                            </div>
                        </div>
                        <div style="
                           position: relative;
                            ...
                            padding: 33px 0;">
                                ...
                                margin-top: 0;
                                letter-spacing: 0px;
                                margin-bottom: 2px;">Invoice #</h3>
                                <span style="float: left;
                                width: 100%;
                                box-sizing: border-box;
                                font-size: 14px;
                                color: #000;">{{$order->invoice_number}}</span>
                            </div>
                        </div>
                        ...
                        <div style="
                            ...
                            padding: 33px 0;">
                                ...
                                font-weight: bold;
                                letter-spacing: 0px;
                                margin-bottom: 2px;">Make a Payment</h3>
                                <a href="{{$order->payment_invoice_url}}"><span style="float: left;
                                width: 100%;
                                box-sizing: border-box;
                                font-size: 14px;
                                color: #000;">Click Here</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                box-sizing: border-box;
                font-weight: bold;
                color: #24a94a; margin-top: 3rem !important; margin-bottom: 0.5rem !important; font-size: 20px;">Est. Shipping Date: {{date("m d Y", strtotime($order->arrival_date))}}</h3>
                ...
                margin-top: 20px;">
                    ...
                    font-size: 18px;
                    box-sizing: border-box;
                    color: #000;"> If you already made payment please disregard.</p>
                </div>
